...
if(searchText === '') {
    error.innerText = 'please display write something';
}
else{
...
const loadPhoneDetail = id => {
  ...
  const displayPhoneDetail = phone => {
    ...
    <div class="card-body">
        ...
        <h3 class="card-title">No release data found${phone.releaseDate}</h3>
        <div>
        <h3 class="card-title">Product details ${phone.name}</h3>

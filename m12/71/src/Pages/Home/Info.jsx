...
const Info = () => {
    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-5'>
            ...
            <InfoCard cardTitle="Contact Us" cardBody='Click the button to listen on Doctors app.' bgClass="bg-gradient-to-r from-secondary to-primary" img={phone}></InfoCard>
        </div>
    );
};
